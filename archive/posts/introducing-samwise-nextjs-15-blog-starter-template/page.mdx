...
export const metadata = {
  ...
  description:
    'Explore Samwise, a high-performance Next.js 15 blog template designed for creators. Enjoy advanced SEO, seamless customization, and stunning design for free.',
  image:
    '/images/introducing-samwise-nextjs-15-blog-starter-template/samwise.webp',
  date: '2025-01-02',
