...
export const metadata = {
  ...
  description: 'Or why in a world full of people trying to be someone else, you should focus on being you.',
  ...
  openGraph: {
    ...
    type: 'article',
    tags: [
      'Or why in a world full of people trying to be someone else, you should focus on being you.',
      'content creation'
    ]
  },
  twitter: {
...
<FootNotes>
  <FootNote id="1">blah blah blah</FootNote>
</FootNotes>
