...
export const metadata = {
  title: "Untitled 01",
  image: `/images/untitled-01/splash.webp`,
  description: "An experimental poem from The Untitled Collection.",
  date: "2024-07-18",
  openGraph: {
    title: "Untitled 01",
    description: "An experimental poem from The Untitled Collection.",
    ...
    images: [
      {
        ...
        alt: "Artwork by Jak Ruiz",
      },
    ],
    type: 'article',
    tags: ["poetry", "experimental writing", "creative writing", "writing"]
  },
  twitter: {
  ...
  keywords: ["poetry", "experimental writing", "creative writing", "writing"],
  slug: "untitled-01",
  readingTime: 2,
};
...
<FootNotes>
  <FootNote>Blog Post Image Source: American painter [Jackson Pollock](https://en.wikipedia.org/wiki/Jackson_Pollock)'s No 5 (1951)</FootNote>
  <Image className="py-2" src="/images/untitled-01/splash.webp" alt="Jackson Pollock - No 5 (1948)" width={200} height={200}/>
</FootNotes>