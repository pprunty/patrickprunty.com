...
export const metadata = {
  ...
  openGraph: {
    ...
    type: 'article',
    tags: ["fantasy", "ASOIAF", "Game of Thrones", "ebook", "pdf", "George R.R. Martin", "reading", "book preview", "downloads"]
  },
  twitter: {
  ...
  keywords: ["fantasy", "ASOIAF", "Game of Thrones", "ebook", "pdf", "George R.R. Martin", "reading", "book preview", "downloads"],
...
The collection includes nine chapters from different character points of view<Ref id="1"/>:
