  ...
  return (
    ...
    >
      ...
      <body className="text-gray-800 dark:text-gray-300 pt-4 p-6 sm:px-2">
        <div
          className="hidden lg:block fixed top-[-20px] z-[110] h-16 w-screen bg-neutral-100 opacity-90 blur dark:top-[-30px] dark:bg-[#222222] dark:opacity-70"
          aria-hidden="true"
        ></div>
        ...
        <div
          className="hidden lg:block fixed bottom-[-20px] z-[110] h-16 w-screen bg-neutral-100 opacity-90 blur dark:bottom-[-30px] dark:bg-[#222222] dark:opacity-70"
          aria-hidden="true"
        ></div>
        <ClientComponents />
        <Analytics />
