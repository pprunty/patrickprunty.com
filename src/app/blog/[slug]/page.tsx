...
export default async function Page({ params }: PageProps) {
  ...
  try {
    ...
    return (
      <div className="break-words before:w-[200px] before:m-auto before:content[''] before:border-t before:border-gray-300 dark:before:border-[#444] before:block before:my-10">
        <UniqueViewers />
        <Content />
      </div>
    );
