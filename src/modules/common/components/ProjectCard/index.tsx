...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <div className="w-full h-full rounded-xl active:opacity-80 active:scale-98 bg-white dark:bg-[#161616] border dark:border-[#444] border-gray-300 rounded-md overflow-hidden transition-all ease-in-out duration-300 hover:shadow-sm">
      {/* Image Section */}
