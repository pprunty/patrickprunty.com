...
const InfoWithTooltip: React.FC<InfoWithTooltipProps> = ({ message }) => {
  ...
  return (
    <div className="relative">
      ...
      {isTooltipVisible && (
        <div
          className={`absolute left-8 top-0 z-10 px-4 py-2 text-sm text-black dark:text-white bg-white dark:bg-[#161616] rounded-lg shadow-xl border dark:border-[#444] transition-transform duration-300 max-w-[200px] min-w-[160px] sm:min-w-[180px] sm:max-w-[220px] ${
