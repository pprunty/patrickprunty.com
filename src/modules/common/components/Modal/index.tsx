  ...
  const modalContent = (
    ...
    >
      ...
      */}
      ...
      >
        <div
          className={`bg-white dark:bg-[#1F1F1F] rounded-lg shadow-xl border dark:border-[#444] transition-transform duration-300 ${
        ...
        >
          ...
          {title && (
            <div className="p-4 border-b border-gray-200 dark:border-[#444] flex items-center justify-between">
              ...
              <button
                className="p-2 rounded-lg dark:border-[#444] bg-[#fff] dark:bg-[#1F1F1F] hover:bg-gray-300 dark:hover:bg-[#313131] transition-opacity"
                onClick={onClose}
                aria-label="Close"
              >
                <svg
